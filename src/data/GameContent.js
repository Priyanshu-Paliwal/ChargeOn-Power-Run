export const levels = [
  {
    ...
    features: [
      ...
      { name: "Custom Mapping & Object Flexibility", category: "Admin", isExclusive: true },
      ...
      { name: "Multiple Payer Relation with Payment Object", category: "Admin", isExclusive: true },
      { name: "Abort Scheduled Payment", category: "Business", isExclusive: true },
      { name: "Automatic Data Retrieval", category: "Business", isExclusive: true },
  ...
  },
  {
    ...
    subtext: "22 more features. Watch for drones — only a lane switch saves you.",
    speedTag: "Speed: 1.3x — Faster",
    speedMultiplier: 1.3,
    requiredCount: 22,
    goodiesPool: ["magnet", "cable protector", "diary & pen"],
    features: [
      { name: "Refund Reason & Notes Capture", category: "Business", isExclusive: true },
      { name: "Recurring Payment Summary Preview", category: "Business", isExclusive: true },
      { name: "Payment Method Active/Inactive", category: "Admin", isExclusive: true },
      { name: "Account Payment Method Update Email Notification", category: "Admin", isExclusive: true },
      { name: "Unresolved Transaction", category: "Admin", isExclusive: true },
      { name: "Recurring Payment Transaction Summary", category: "Business", isExclusive: true },
      { name: "Upfront Installment", category: "Business", isExclusive: true },
      { name: "Error Logs", category: "Admin", isExclusive: true },
      { name: "Automated Collection", category: "Admin" },
      { name: "Recaptcha on Payment Links", category: "Admin", isExclusive: true },
      { name: "Payment Gateway Fallback Mechanism", category: "Admin", isExclusive: true },
      { name: "Invoice", category: "Admin", isExclusive: true },
      { name: "Pre-Charge Customer Email Notifications", category: "Business", isExclusive: true },
      ...
      { name: "Surcharging", category: "Admin & Business", isExclusive: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "ChargeOn Agent Assistant", category: "Business", isExclusive: true },
      { name: "Payment Gateway Environment Switching", category: "Admin" },
      { name: "Experience Cloud Payment Portal", category: "Business", isExclusive: true },
      ...
      { name: "Headless 360", category: "Admin & Business", isExclusive: true }
    ],
    blockers: [
